  ...
  const HoverButton = () => {
    ...
    return (
      <Pressable
        style={[
          styles.button,
          { backgroundColor: isHovered ? '#4CAF50' : '#8BC34A' }, // Change color on hover
        ]}
...
const styles = StyleSheet.create({
  ...
  container_2: {
    flexDirection: "row",  // Align items in a row (columns)
    justifyContent: "space-between", // Optional, depending on how you want to space items
