...
const App = () => {
  ...
  const annaNagarLocation = {
    latitude: 13.084926, // Latitude of Anna Nagar Roundana
    longitude:  Z80.213698, // Longitude of Anna Nagar Roundana
    latitudeDelta: 0.01,
    longitudeDelta: 0.01,
  };
  ...
  useEffect(() => {
    Geolocation.getCurrentPosition(
      (position) => {
        console.log('User location:', position.coords); // Check if you're getting the location
