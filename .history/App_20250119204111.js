  ...
  const HoverButton = () => {
    ...
    return (
      <Pressable
        style={[
          styles.button,
          { backgroundColor: isHovered ? '#89FE65' : '#4CAF50' }, // Default color updated
          { borderColor: isHovered ? '#FFF' : '#000' }, // Border change on hover
        ]}
        onPressIn={() => setIsHovered(true)} // When button is pressed
        onPressOut={() => setIsHovered(false)} // When button press is released
      >
        <Text style={styles.buttonText}>At Pickup</Text>
      </Pressable>
    );
  };
  ...
  const HoverButton2 = () => {
    ...
    return (
      <Pressable
        style={[
          styles.button,
          { backgroundColor: isHovered2 ? '#FF4D4D' : '#f44336' }, // Default color updated
          { borderColor: isHovered2 ? '#FFF' : '#000' }, // Border change on hover
        ]}
