...
const App = () => {
  const [region, setRegion] = useState({
    latitude: 13.085375, // Default location
    longitude: 80.213750, // Default location
    latitudeDelta: 0.01,
    longitudeDelta: 0.01,
  });
  ...
  const getUserLocation = async () => {
    ...
    try {
      ...
      console.error("Permission check or location fetch error: ", error);
      setIsLoading(false);
      Alert.alert("Error", "An error occurred while checking location permissions");
    }
  };
