  ...
  const HoverButton = () => {
    ...
    return (
      <Pressable
        style={[
          styles.button,
          { backgroundColor: isHovered ? '#89FE65' : '#fff' },
          { backgroundColor: isHovered ? '#89FE65' : '#fff' }, // Change color on hover
        ]}
        onPressIn={() => setIsHovered(true)} // When button is pressed
        onPressOut={() => setIsHovered(false)} // When button press is released
        //onPress={() => alert('Button Pressed')} // Button press action
      >
  ...
  const HoverButton2 = () => {
    ...
    return (
      <Pressable
        style={[
          styles.button,
          { backgroundColor: isHovered2 ? '#FF4D4D' : '#fff' }, // Change color on hover
        ]}
